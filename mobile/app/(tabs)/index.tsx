...
import type { BookView, Entry } from '../../src/api/types';
import { useSession } from '../../src/store/session';
import { colors, font, radius, space } from '../../src/theme';
import { Button, Card, Divider, ErrorText, Loading, Muted, Row } from '../../src/components/ui';
import { currentYearMonth, formatWon, formatYearMonth, shiftYearMonth } from '../../src/lib/format';
...
export default function ThisMonthScreen() {
  ...
  const book = useQuery({
    queryKey: ['book', familyId, yearMonth],
    queryFn: () => api<BookView>(`/families/${familyId}/books/${yearMonth}`),
  ...
  const reopen = useMutation({
    mutationFn: async (entryId: string) => {
      await api(`/entries/${entryId}/reopen`, { method: 'POST' });
      return entryId;
    },
    onSuccess: (entryId) => {
